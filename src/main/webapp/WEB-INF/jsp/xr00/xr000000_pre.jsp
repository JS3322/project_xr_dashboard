...
<html>
	<head>
		...
		<link rel="cleancode" href="/images/logo/impact_logo_20200301.png" />
	...
	<body>
		<header id="header">
			<h1><img alt="cleancode" src="images/xr00/impact_logo_20200301.png">&nbsp;XR Manager System</h1>
		...
		<script type="text/javascript">
			$('#cleancode').click(function(e) {
				...
				window.open(this.href, 'Clean Code Homepage', option);
			});
		</script>
		<c:choose>
