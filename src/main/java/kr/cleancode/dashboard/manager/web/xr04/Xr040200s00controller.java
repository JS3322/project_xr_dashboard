...
@Controller
public class Xr040200s00controller {
	private final Logger logger = LogManager.getLogger(Xr040200s00controller.class);

	
	@RequestMapping(value = {"xr040200s00controller.do"})
