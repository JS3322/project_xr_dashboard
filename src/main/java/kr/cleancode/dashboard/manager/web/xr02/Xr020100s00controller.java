...
@Controller
public class Xr020100s00controller {
	private final Logger logger = LogManager.getLogger(Xr020100s00controller.class);

	@RequestMapping(value = {"xr020100s00controller.do"})
