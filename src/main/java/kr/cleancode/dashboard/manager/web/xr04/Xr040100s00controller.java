...
@Controller
public class Xr040100s00controller {
	private final Logger logger = LogManager.getLogger(Xr040100s00controller.class);

	@RequestMapping(value = {"xr040100s00controller.do"})
